...
<header id="header" id="home">
  <div class="container">
    <div class="row align-items-center justify-content-between d-flex">
      <div id="logo">
        <a href="#"><img src="views/user/img/logo.png" alt="Logo" title=""  /></a>
      </div>
      <nav id="nav-menu-container">
        <ul class="nav-menu ">
          ...
          <li class="menu-has-children"><a href="#">Practises</a>
            <ul>
              <li><a href="<c:url value="/ReadStoryServlet"/>">Reading</a></li>
      ...
      </nav style="font-size: 50%"><!-- #nav-menu-container -->
    </div>
  </div>
</header><!-- #header -->
...
<%--        <h5 class="text-white text-uppercase">Tafakkoor Books</h5>--%>
        ...
        <p class="text-white pt-20 pb-20">
          Learning without thinking is blindness <br> Thinking without learning is dangerous <br> <i>Confucius</i>
        </p>
      ...
      <div class="col-lg-5 col-md-6 col-sm-6">
        <div class="single-footer-widget">
          ...
          <p class="footer-text">
            ...
            Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Made with <i class="fa fa-heart-o" aria-hidden="true"></i> by Tafakkoor Team</a>
            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
          </p>
        </div>
      </div>
